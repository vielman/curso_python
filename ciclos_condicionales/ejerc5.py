import os
os.system('cls')
# Mostrar en pantalla la palabra que más se repita junto 
# con la cantidad de veces que lo hace del capituló número
# uno de Frankenstein

frankenstein = """TO Mrs. Saville, England
...
resultado = frankenstein.split(" ")

frecuenciaPalab = [resultado.count(w) for w in resultado]

resul = str(list(zip(resultado, frecuenciaPalab)))

diccionario = dict(list(zip(resultado,frecuenciaPalab)))
# diccOrdenado = ordenaDicFrec(diccionario)

# print("Lista\n" + str(resultado) + "\n")
# print("Frecuencias\n" + str(frecuenciaPalab) + "\n")
# print("Pares\n" + str(list(zip(resultado, frecuenciaPalab))))
# print("Frecuencias\n" + resul + "\n")
print(diccionario)
